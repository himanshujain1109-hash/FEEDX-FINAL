    ...
    <div>
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-20 md:grid-cols-2 md:items-center md:py-28">
          <div className="animate-floatUp">
            ...
            <p className="mt-6 max-w-md text-lg text-paper/80">
              FoodBridge AI connects restaurants and hotels with verified NGOs the moment food is
          ...
          <div className="animate-floatUp rounded-xl2 border border-canopy-400 bg-canopy-600 p-8" style={{ animationDelay: "0.1s" }}>
            ...
            <div className="mt-6 grid grid-cols-3 gap-4 border-t border-canopy-400 pt-6 text-center">
              <div>
                <p className="font-display text-2xl font-semibold text-mango">1,024</p>
                <p className="text-xs text-paper/60">meals saved</p>
              </div>
              <div>
                <p className="font-display text-2xl font-semibold text-mango">520 kg</p>
                <p className="text-xs text-paper/60">CO₂ avoided</p>
              </div>
              <div>
                <p className="font-display text-2xl font-semibold text-mango">38</p>
                <p className="text-xs text-paper/60">NGOs active</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="impact" className="mx-auto max-w-6xl px-6 py-20 text-center">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-3">
          <div className="card">
            <p className="font-display text-4xl font-semibold text-signal-600">1,024</p>
            <p className="mt-1 text-sm text-ink/60">Meals rescued</p>
          </div>
          <div className="card">
            <p className="font-display text-4xl font-semibold text-signal-600">520 kg</p>
            <p className="mt-1 text-sm text-ink/60">CO₂e avoided</p>
          </div>
          <div className="card">
            <p className="font-display text-4xl font-semibold text-signal-600">38</p>
            <p className="mt-1 text-sm text-ink/60">Verified NGOs</p>
          </div>
        </div>
      </section>
    </div>
